...
public class BasePage<T> : ContentPage where T : BaseViewModel
{
	...
	public static readonly BindableProperty ViewModelProperty = BindableProperty.Create(nameof(ViewModel), typeof(T), typeof(BasePage<T>), default(T), BindingMode.TwoWay);
	public T ViewModel {
